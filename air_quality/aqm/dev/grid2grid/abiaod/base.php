...
<head>
<meta charset="UTF-8">
<title>AQM Atmospheric Verification - Parallel - G2G: Hourly Aerosol Optical Depth</title>
...
<!-- Head element -->
<div class="page-top">
        <span><a style="color:#ffffff">GRID-TO-GRID (ATMOSPHERIC): Hourly Aerosol Optical Depth</a></span>
</div>
...
<table id="tbl-map" style="margin:auto">
     <tbody>
       <tr>
        <td id ="td-map">
           <img name="map_image" src="../images/evs.aqm.fbar_obar.aod_l0.last31days.timeseries_day2_init12z.na_buk_conus.png" style="width:100%">
        </td>
      </tr>
    </tbody>
</table>
...
var url = "../images/evs.aqm.MMM.aod_LLL.DDD.PPP_FFF_HHH.na_RRR.png";

//====================================================================================================
//Add years & months
//====================================================================================================

var plottypes = []; var metrics = []; var dateranges = [];
var inithours = [];
var forecastdays = [];
var levels = [];
var regions = [];
...
/*  not for initial showing for time series option
metrics.push({
