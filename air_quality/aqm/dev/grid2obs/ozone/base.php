...
<head>
<meta charset="UTF-8">
<title>AQM Atmospheric Verification - Parallel - G2O: Hourly OZONE</title>
...
<!-- Head element -->
<div class="page-top">
        <span><a style="color:#ffffff">GRID-TO-OBS (ATMOSPHERIC): Hourly OZONE</a></span>
</div>
...
<table id="tbl-map" style="margin:auto">
     <tbody>
       <tr>
        <td id ="td-map">
           <img name="map_image" src="../images/evs.aqm.fbar_obar.ozcon1_a1.last31days.timeseries_day2_init12z.na_buk_conus.png" style="width:100%">
        </td>
      </tr>
    </tbody>
</table>
...
var url = "../images/evs.aqm.MMM.ozcon1_LLL.DDD.PPP_FFF_HHH.na_RRR.png";
