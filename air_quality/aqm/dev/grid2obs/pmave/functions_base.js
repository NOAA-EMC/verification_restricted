...
// 	}
function getURL(plottype,metric,daterange,inithour,forecastday,level,region,frame){
...
function showImage(){
	...
	var url = getURL(imageObj.plottype,imageObj.metric,imageObj.daterange,imageObj.inithour,imageObj.forecastday,imageObj.level,imageObj.region,i);
