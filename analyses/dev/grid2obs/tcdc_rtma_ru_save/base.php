...
<!-- Head element -->
<div class="page-top">
        <span><a style="color:#ffffff">RTMA-RU GRID-TO-OBS (ATMOSPHERIC): TOTAL CLOUD</a></span>
</div>
...
<table id="tbl-map" style="margin:auto">
     <tbody>
       <tr>
        <td id ="td-map">
           <img name="map_image" src="../images/evs.rtma_ru.fbias.tcdc_l0.last31days.threshmean.buk_conus.png" style="width:100%">
        </td>
      </tr>
    </tbody>
</table>
...
var url = "https://www.emc.ncep.noaa.gov/users/verification_restricted/analyses/dev/grid2obs/images/evs.rtma_ru.MMM.tcdc_TTT.DDD.PPP.RRR.png";
