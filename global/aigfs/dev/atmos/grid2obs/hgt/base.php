...
<head>
<meta charset="UTF-8">
<title>Global-EAGLE-Solo (deterministic) Verification - Experimental - Atmospheric G2O: Geopotential Height</title>
...
var url = "https://www.emc.ncep.noaa.gov/users/verification_restricted/global/aigfs/dev/atmos/grid2obs/images/evs.global_det.MMM.hgt_LLL.DDD.PPP_validHHHz_fFFF.g004_RRR.png";
...
vertprof_forecasthours = ["006", "012", "018", "024", "072", "120", "168", "240", "312", "384"]
vertprof_fhrmean_forecasthours = ["384"]
vertprof_levels = ["all", "trop", "ltrop"]
vertprof_levels_name = ["All", "Troposphere", "Lower Troposphere"]
