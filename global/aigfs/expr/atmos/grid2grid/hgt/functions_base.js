...
function getURL(plottype,metric,daterange,validhour,forecasthour,wavedecomp,level,region,frame){
...
function showImage(){
	...
	var url = getURL(imageObj.plottype,imageObj.metric,imageObj.daterange,imageObj.validhour,imageObj.forecasthour,imageObj.wavedecomp,imageObj.level,imageObj.region,i);
	...
	document.getElementById("wavedecomp").selectedIndex = searchByName(imageObj.wavedecomp,wavedecomps);
