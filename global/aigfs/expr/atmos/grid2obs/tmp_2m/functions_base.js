...
function getURL(plottype,metric,daterange,validhour,forecasthour,region,frame){
...
function showImage(){
	...
	var url = getURL(imageObj.plottype,imageObj.metric,imageObj.daterange,imageObj.validhour,imageObj.forecasthour,imageObj.region,i);
...
function changeValidHour(id){
	...
	if(selected_validhour=="_valid03z"||selected_validhour=="_valid09z"||selected_validhour=="_valid15z"||selected_validhour=="_valid21z"){
	...
	if(selected_plottype=="timeseries"){
		...
		forecasthours = [];
			...
			forecasthours.push({
                            ...
                            name: "_f"+validhour_forecasthours[i],
                        })
		}
                for(i=0; i<forecasthours.length; i++){
                var option = document.createElement("option");
