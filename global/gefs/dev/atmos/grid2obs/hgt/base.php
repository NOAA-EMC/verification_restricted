...
<table id="tbl-map" style="margin:auto">
     <tbody>
       <tr>
        <td id ="td-map">
           <img name="map_image" src="../images/evs.global_ens.rmse_spread.hgt_p700.last90days.timeseries.valid00z_12z_f360.g003_glb.png" style="width:100%">
        </td>
      </tr>
    </tbody>
</table>
...
var url = "https://www.emc.ncep.noaa.gov/users/verification_restricted/global/gefs/dev/atmos/grid2obs/images/evs.global_ens.MMM.hgt_LLL.DDD.PPP_validHHH_fFFF.g003_RRR.png";
...
non_vertprof_levels = ["p1000", "p500"]
non_vertprof_levels_name = ["1000 hPa", "500 hPa"]
