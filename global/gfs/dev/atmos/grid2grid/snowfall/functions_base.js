...
function getURL(plottype,metric,daterange,validhour,forecasthour,region,threshold,derivedvar,frame){
...
function showImage(){
	...
	var url = getURL(imageObj.plottype,imageObj.metric,imageObj.daterange,imageObj.validhour,imageObj.forecasthour,imageObj.region,imageObj.threshold,imageObj.derivedvar,i);
...
function changeMetric(id){
	...
	if( (selected_metric=="fss_width1") || (selected_metric=="fss_width13") || (selected_metric=="fss_width23") || (selected_metric=="fss_width33") || (selected_metric=="fss_width43") || (selected_metric=="fss_width53") || (selected_metric=="fss_width63")){
...
//Change the derived var from dropdown menu
