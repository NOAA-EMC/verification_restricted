...
<head>
<meta charset="UTF-8">
<title>GFS Verification - Development - Atmospheric G2G: Sea Surface Temperature</title>
...
<!-- Banner -->
<div class="page-middle" id="page-middle" style="color: black; background-color: LightSkyBlue; font-size: 0.9em;">
GFS SST metrics use model skin temperature because GFSv16 is not a coupled model and foundation SST is not included in GFSv16 forecast files. GHRSST-OSPO L4 foundation SST is used for SST validation. Values < -2ºC are masked out. Because skin temperature and foundation SST are physically distinct, results should be interpreted with caution. Foundation SST forecasts will be used when GFSv17 becomes operational.
</div>
<!-- /Banner -->
...
var url = "https://www.emc.ncep.noaa.gov/users/verification_restricted/global/gfs/dev/atmos/grid2grid/images/evs.global_det.MMM.sst_dailyavg_z0.DDD.PPP_validHHHz_fFFF.g004_RRR.png";
