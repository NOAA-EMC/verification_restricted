...
<head>
<meta charset="UTF-8">
<title>GFS Verification - Development - Wave - G2O: 10 meter Wind Direction</title>
...
<!-- Head element -->
<div class="page-top">
    <span><a style="color:#ffffff">GRID-TO-OBS (WAVE): 10 METER WIND DIRECTION</a></span>
</div>
...
<table id="tbl-map" style="margin:auto">
     <tbody>
       <tr>
        <td id ="td-map">
           <img name="map_image" src="../images/evs.global_det.corr.htsgw_l0_sfcshp.last31days.timeseries_valid00z_f000.global_0p25.png" style="width:100%">
        </td>
      </tr>
    </tbody>
</table>
...
var url = "https://www.emc.ncep.noaa.gov/users/verification_restricted/global/gfs/dev/wave/grid2obs/images/evs.global_det.MMM.ugrd_vgrd_l0_OOO.DDD.PPP_validHHHz_fFFF.latlon_0p25_RRR.png";
...
//ndbc_standard_regions = ["glb", "seus_carb", "goa", "neus_can", "wcoast_ak", "hawaii"]
