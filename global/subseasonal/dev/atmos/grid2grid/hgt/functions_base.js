...
function getURL(plottype,avgtype,metric,daterange,validhour,forecasthour,level,region,frame){
	var newurl = url.replace("TTT",plottype);
...
function showImage(){
	...
	var url = getURL(imageObj.plottype,imageObj.avgtype,imageObj.metric,imageObj.daterange,imageObj.validhour,imageObj.forecasthour,imageObj.level,imageObj.region,i);
