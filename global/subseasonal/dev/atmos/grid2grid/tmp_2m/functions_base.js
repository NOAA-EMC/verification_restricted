...
function getURL(plottype,avgtype,metric,daterange,validhour,forecasthour,region,frame){
...
function showImage(){
	...
	var url = getURL(imageObj.plottype,imageObj.avgtype,imageObj.metric,imageObj.daterange,imageObj.validhour,imageObj.forecasthour,imageObj.region,i);
