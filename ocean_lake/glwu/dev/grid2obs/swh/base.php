...
<head>
<meta charset="UTF-8">
<title>GLWU Verification - G2O: Significant Wave Height</title>
...
<table id="tbl-map" style="margin:auto">
     <tbody>
       <tr>
        <td id ="td-map">
           <img name="map_image" src="../images/evs.glwu.fbar_obar.htsgw_l0_ndbc_standard.last90days.timeseries_valid01z_f000.greatlakes.png" style="width:100%">
        </td>
      </tr>
    </tbody>
</table>
...
var url1 = "https://www.emc.ncep.noaa.gov/users/verification_restricted/ocean_lake/glwu/dev/grid2obs/images/evs.glwu.MMM.htsgw_l0_OOO.DDD.PPP_validHHHz_fFFF.RRR.png";
var url2 = "https://www.emc.ncep.noaa.gov/users/verification_restricted/ocean_lake/glwu/dev/grid2obs/images/evs.glwu.MMM.htsgw_l0_OOO.DDD.PPP_validHHHz_fFFF.RRR.png";
