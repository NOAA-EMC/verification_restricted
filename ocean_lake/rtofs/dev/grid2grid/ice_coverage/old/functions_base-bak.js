...
function showImage(){
	...
	var url = getURL(imageObj.plottype,imageObj.metric,imageObj.daterange,imageObj.validhour,imageObj.forecasthour,imageObj.region,imageObj.obstype,imageObj.level,i);
...
function changePlotType(id){
	...
	if(selected_plottype=="timeseries"){
		...
		plottype_forecasthours_name = timeseries_forecasthours_name;
	}
...
function changeMetric(id){
	...
	var selected_metric = document.getElementById("metric").value;
        var selected_plottype = document.getElementById("plottype").value;
 	if(selected_plottype=="timeseries"){
        	var selected_forecasthour = document.getElementById("forecasthouor").value;
        	var element = document.getElementById("forecasthour");
                for(i = element.options.length - 1 ; i >= 0 ; i--){element.remove(i);}
                        ...
                        metric_forecasthours = metric_forecasthours;
                }
                forecasthours = [];
...
//Change the observation type from dropdown menu
