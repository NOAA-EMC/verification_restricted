...
function changeRegion(id){
    ...
    if(selected_region=="alaska"){
            region_levels = alaska_levels;
            region_levels_name = alaska_levels_name;
    }
    else{
            region_levels = non_alaska_levels;
            region_levels_name = non_alaska_levels_name;
    }
    levels = [];
    for(i=0; i<region_levels.length; i++){
        levels.push({
            displayName:  region_levels_name[i],
            name: region_levels[i],
            })
    }
    for(i=0; i<levels.length; i++){
        var option = document.createElement("option");
