...
<head>
<meta charset="UTF-8">
<title>RRFS-CHEM Verification - G2O: Hourly PM<sub>10</sub></title>
...
<!-- Head element -->
<div class="page-top">
        <span><a style="color:#ffffff">GRID-TO-OBS (ATMOSPHERIC): Hourly PM<sub>10</sub></a></span>
</div>
...
<table id="tbl-map" style="margin:auto">
     <tbody>
       <tr>
        <td id ="td-map">
           <img name="map_image" src="../images/evs.rrfs_chem.fbar_obar.pmtc_z8.last31days.timeseries_day2_init12z.na_buk_conus.png" style="width:100%">
        </td>
      </tr>
    </tbody>
</table>
...
var url = "../images/evs.rrfs_chem.MMMTTTpmtc_LLL.DDD.PPP_FFF_HHH.na_RRR.png";
...
// Threshold options
csi_thresholds = ["_gt10.", "_gt20.", "_gt30.", "_gt40.", "_gt60.", "_gt80.", "_gt100.", "_gt200."]
csi_thresholds_name = ["> 10", "> 20", "> 30", "> 40", "> 60", "> 80", "> 100", "> 200"]
other_thresholds = ["."]
other_thresholds_name = ["NA"]
all_thresholds = [".", "_gt10.",  "_gt20.", "_gt30.", "_gt40.", "_gt60.", "_gt80.", "_gt100.", "_gt200.", "."]
all_thresholds_name = ["NA", "> 10", "> 20", "> 30", "> 40", "> 60", "> 80", "> 100", "> 200", "ALL"]
//====================================================================================================
//Initialize the page
//====================================================================================================
